...
-- v0.9.G Shop専用I18nアダプタ（後でLocale.luaへ移植しやすい形）
local M = {}
...
local en = {
  ...
  summary_unlimited_fmt  = "Rerolls: unlimited / Cost: %d",
  summary_remaining_fmt  = "Rerolls left: %d / Cost: %d",
...
local ja = {
  ...
  summary_unlimited_fmt  = "リロール: 無制限 / 1回 %d 文",
  summary_remaining_fmt  = "リロール: 残り %d 回 / 1回 %d 文",
